...
>
    ...
    >
        <div class="ps-3 pe-4">
            <flux:icon name="chevron-down" class="hidden size-3! group-data-open/disclosure-button:block" />
            <flux:icon name="chevron-right" class="block size-3! group-data-open/disclosure-button:hidden" />
        </div>
