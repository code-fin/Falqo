...
<flux:breadcrumbs>
    <flux:breadcrumbs.item :href="route('dashboard')" icon="home" class="transition-colors hover:!text-falqo-600 hover:no-underline" wire:navigate>{{ __('Dashboard') }}</flux:breadcrumbs.item>
